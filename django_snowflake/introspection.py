...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    def identifier_converter(self, name):
        ...
        # would replace the special handling of SYS_CONSTRAINT_ right above.
        # if name != name.upper():
        #    return f'"{name}"'
        # Otherwise, the identifier can be lowercased for use as a model field
        # name, for example. DatabaseOperations.quote_name() will uppercase
        # it in queries.
        return name.lower()
